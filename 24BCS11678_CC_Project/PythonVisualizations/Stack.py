...
"""
    ...
    def push(self, val, code=pushCode, start=True):
        ...
        self.highlightCode('top++;', callEnviron)
        ...
        self.highlightCode('stackList[top] = item;', callEnviron)
...
"""
    ...
    def pop(self, code=popCode, start=True):
        ...
        self.highlightCode('T top_val = stackList[top];', callEnviron)
        ...
        # clear stack cell
        self.highlightCode('stackList[top] = NULL;', callEnviron)
        ...
        self.highlightCode('return top_val;', callEnviron)
...
"""
    ...
    def peek(self, code=peekCode, start=True):
        ...
        self.highlightCode('!isEmpty()', callEnviron)
        ...
        self.highlightCode('return stackList[top];', callEnviron)
...
bool isEmpty() {{
    ...
    def isEmpty(self, code=isEmptyCode):
        ...
        self.highlightCode('return top < 0;', callEnviron)
        self.wait(0.3)
...
'''
    ...
    def display(self, newSize=None, code=newCode, start=True):
        ...
        if newSize is not None:
            ...
            try:
                self.highlightCode(
                    'stackList = new T[max];', callEnviron, wait=wait)
            except UserStop:
                wait = 0
            self.size = newSize
        ...
        if callEnviron:
            try:
                self.highlightCode('top = -1;', callEnviron, wait=wait)
            except UserStop:
                wait = 0
